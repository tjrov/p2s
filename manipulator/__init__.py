...
import pygame  # pip install python
...
class Manipulator(Thread):
   ...
   def start(self):
      pygame.init()
      pygame.display.set_mode((1, 1))  # big display not needed, no display = no inputs
...
object = Manipulator()
object.start()  # concerns: pygame needs to build a display to operate
