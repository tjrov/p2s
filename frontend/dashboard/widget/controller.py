...
class ControllerWidget(Widget):
    ...
    """
    ------------------------------------------------------------------------------------------------------------------------
    Maps the controller input to things. Do things here!!!
    ------------------------------------------------------------------------------------------------------------------------
    """
    def update(self):
        self.joystick.dispatch_events()
        ...
        def on_button(button, pressed):
            """tempYeet = "Not Pressed"
            if (pressed == 1):
                tempYeet = "Pressed"
            labelTextVar.set('button: ' + str(button) + ' ' + tempYeet)
            print(labelTextVar.get())
            self.canvas.update()
...
"""
------------------------------------------------------------------------------------------------------------------------
Definitions for Controller Values
------------------------------------------------------------------------------------------------------------------------
"""
...
class XInputJoystick(event.EventDispatcher):
    ...
    def on_missed_packet(self, number):
        pass
#Definitions for the joystick methods
