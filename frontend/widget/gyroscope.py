...
class GyroscopeWidget(Widget):
    ...
    def __init__(self, left_corner, canvas):
        ...
        self.text_id_x = canvas.create_text(self.left_x + self.WIDTH / 2, self.left_y + self.HEIGHT / 2 + 10, font=("Verdana", "32"), fill="#9D8AFE")
        self.text_id_y = canvas.create_text(self.left_x + self.WIDTH / 2, self.left_y + self.HEIGHT / 2 + 30 + self.HEIGHT + 10, font=("Verdana", "32"), fill="#5FC794")
        self.text_id_z = canvas.create_text(self.left_x + self.WIDTH / 2, self.left_y + self.HEIGHT / 2 + 60 + 2 * self.HEIGHT + 10, font=("Verdana", "32"), fill="#F3D067")
